...
public class Adegan {
    ...
    int jumPil = 0;
    ArrayList<Pilihan> arrPilihan = new ArrayList<Pilihan>();
    ...
    public void mainkan() {
        ...
        System.out.println("Kesehatan: "+oPlayer.kesehatan);
        ...
        if (oPlayer.kesehatan<=0){
            System.out.println("Rudi meninggal karena kecapean, permainan berakhir");
